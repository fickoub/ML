      ...
      <header className={props.className}>
        <div className="flex flex-col items-center justify-center mt-2.5 mx-auto w-[93%]">
          <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
            ...
            <Text
              className="common-pointer font-bold font-inter md:ml-[0] ml-[68px] text-left text-white_A700 w-auto"
              as="h6"
              variant="h6"
              onClick={() => navigate("/")}
            >
            ...
            <Text
              className="font-bold font-inter md:ml-[0] ml-[77px] text-left text-white_A700 w-auto"
              as="h6"
              variant="h6"
            >
              Historique
          ...
          <div className="bg-amber_900 h-2.5 md:ml-[0] ml-[438px] mr-[754px] w-[11%]"></div>
        </div>
      </header>
    </>
  );
